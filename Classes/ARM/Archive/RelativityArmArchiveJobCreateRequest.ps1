<#
.SYNOPSIS
This class represents a request to create an ARM Archive Job in Relativity.

.DESCRIPTION
The RelativityArmArchiveJobCreateRequest class encapsulates all the parameters required to create an ARM Archive Job request. 
...
.EXAMPLE
$archiveJobRequest = [RelativityArmArchiveJobCreateRequest]::new(
    12345,
    "High",
...
.NOTES
Make sure to provide valid values for all the parameters to ensure successful job creation.
#>
