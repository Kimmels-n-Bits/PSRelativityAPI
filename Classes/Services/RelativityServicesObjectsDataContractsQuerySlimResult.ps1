class RelativityServicesObjectsDataContractsQuerySlimResult
{
    <#
        .SYNOPSIS
    ...
    [Collections.Generic.List[RelativityServicesObjectsDataContractsField]] $Fields
    [Collections.Generic.List[Int32]] $IDWindow
    [Collections.Generic.List[RelativityServicesObjectsDataContractsRelativityObjectSlim]] $Objects
    ...
    RelativityServicesObjectsDataContractsQuerySlimResult (
    ...
    )
    {
        ...
        $ApiResponse.Fields | ForEach-Object {
            $this.Fields.Add([RelativityServicesObjectsDataContractsField]::new($_))
        }

        $this.Objects = @()
        $ApiResponse.Objects | ForEach-Object {
            $this.Objects.Add([RelativityServicesObjectsDataContractsRelativityObjectSlim]::new($_))
        }
